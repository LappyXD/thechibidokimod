...
import net.lappy.thechibidokimod.procedures.ChibidewPlayerFinishesUsingItemProcedure;

public class ChibidewItem extends Item {
	public ChibidewItem() {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		ChibidewPlayerFinishesUsingItemProcedure.execute(entity);
		return retval;
	}
}
